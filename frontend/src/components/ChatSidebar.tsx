...
const ChatSidebar = ({
  ...
  return (
    ...
    >
      ...
      <div className='flex items-center justify-between'>
        ...
        <button className={`p-2.5 rounded-lg transition-colors ${showAllUsers ? "bg-red-600 hover:bg-red-700 text-white" :
      ...
      <div className='flex-1 overflow-hidden px-4 py-2'>
        {
          showAllUsers? (<div className='space-y-4 h-full'>
            <div className='relative'>
              ...
              className='w-full pl-10 pr-4 py-3 bg-gray-800 
              border border-gray-700 text-white placeholder-gray-400'
              value={searchQuery}
            ...
            <div className='space-y-2 overflow-y-auto h-full pb-4'>
              {
                users?.filter((u)=> u._id !== loggedInUser?._id && u.name.toLowerCase().includes(searchQuery.toLocaleLowerCase())).map((u)=>(
                  <button key={u._id} className='w-full text-left p-4 rounded-lg border border-gray-700 hover:border-gray-600
                    ...
                    <div className='flex items-center gap-3'>
                      <div className='relative'>
                        ...
                        onlineUsers.includes(u._id) && (
                          <span className='absolute -top-0.5 -right-0.5 w-3.5 h-3.5 bg-green-500 border-2 border-gray-900 rounded-full'></span>
                        )
                      }
                      ...
                      <div className='text-ts textgray-400 mt-0.5'>
                        {/* to show online text */}
                        {
                          onlineUsers.includes(u._id) ? (
            ...
            </div>) : chats && chats.length > 0 ? (<div className='space-y-2 overflow-y-auto h-full pb-4'>
              {
                chats.map((chat)=>{
                  ...
                  className={`w-full text-left p-4 rounded-lg transition-colors ${
                    isSelected ?"bg-blue-600 border border-blue-500"
                      ...
                      <div className='relative'>
                       ...
                       <div className='flex-1 min-w-0'>
                          <div className='flex items-center justify-between mb-1'>
                            ...
                            {
                              unseenCount >0 &&  (<div className='bg-red-600 text-white text-xs font-bold rounded-full min-w-[22px] h-5.5 flex
              ...
              <p className="text-gray-400">No Conversion yet</p>
  ...
  <span className="font-medium text-gray-300">Profile</span>
   ...
   <button onClick={handleLogout} className='w-full items-center gap-3 px-4 py-3 rounded-lg
